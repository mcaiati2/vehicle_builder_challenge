...
```md
GIVEN a command-line application that accepts user input y
WHEN I am prompted to create a new vehicle or existing vehicle y
THEN I can choose between the two options y
WHEN I am prompted to choose the vehicle type during creation y
THEN I can choose between car, truck, and motorbike y
WHEN I am prompted for details about the vehicle y
THEN I can enter the vehicle information y
WHEN I have entered all the vehicle information y
THEN I can use the created vehicle y
WHEN I select an existing vehicle y
THEN I can use the selected existing vehicle y
WHEN I have created a new vehicle or selected an existing vehicle y
THEN I can perform actions with that vehicle y
WHEN I perform an action with a vehicle y
THEN I see the result of the action in the command-line y
WHEN I complete the process of performing an action y
THEN I can perform additional actions until I choose to exit y
```
